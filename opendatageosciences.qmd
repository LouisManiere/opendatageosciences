...
-   Sélection des nettoyages des données (fichier unique ou collection de fichiers)
-   Collection :
    -   structurer l'arborescence avec règles de nommage et fichier de description
...
-   Souvent des templates détaillés (reprise des métadonnées)
...
::: columns
::: {.column width="70%"}
### Entrepôt CNRS et générique recherche.data.gouv.fr
...
-   ![](./img/cc_by.png){width="10%"} CC BY (ou Etalab 2.0) : Attribution des auteurs, tout est permis
-   ![](./img/cc_by_nc.png){width="10%"} CC BY-NC : Attribution et pas d'utilisation commerciale
-   ![](./img/cc_by_sa.png){width="10%"} CC BY-SA : Attribution et obligation de partage en CC BY-SA

Codes :

-   MIT : Attribution des auteurs, tout est permis
-   GPL/GNU : Attribution et obligation de partage en GPL/GNU
...
Mais... on peut aussi partager une [présentation ?]()
